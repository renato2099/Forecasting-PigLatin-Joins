...
query7DdSs = JOIN ss_proy BY ss_sold_date_sk, dd_proy BY d_date_sk USING 'replicated';

STORE query7DdSs INTO 'queryResults/query.7.store_sales.date_dim.1.1' USING PigStorage('|');

rm queryResults/query.7.store_sales.date_dim.1.1;
