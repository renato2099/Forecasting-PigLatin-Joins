...
joinCustomerSSales = JOIN ss_proy BY ss_customer_sk, customer_proy BY c_customer_sk USING 'replicated';

STORE joinCustomerSSales INTO 'queryResults/query.7.store_sales.customer.4.1' USING PigStorage('|');

rm queryResults/query.7.store_sales.customer.4.1;
