...
proy_catalogSales2 = FOREACH catalog_sales2 GENERATE cs_order_number;

join_catSales_catSales2 = JOIN proy_catalogSales BY cs_order_number, proy_catalogSales2 BY cs_order_number;

STORE join_catSales_catSales2 INTO 'queryResults/query.33.catalog_sales.catalog_sales.18.18' using PigStorage('|');

rm queryResults/query.33.catalog_sales.catalog_sales.18.18;
