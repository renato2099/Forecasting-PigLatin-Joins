...
join_webSales_webSite = JOIN proy_webSite BY web_site_sk, proy_webSales BY ws_web_site_sk;

STORE join_webSales_webSite INTO 'queryResults/query6.web_site.web_sales.1.14' USING PigStorage('|');

rm queryResults/query6.web_site.web_sales.1.14;
