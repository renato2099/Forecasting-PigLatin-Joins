...
proy_storeReturns = FOREACH store_returns GENERATE sr_ticket_number;
proy_storeSales = FOREACH store_sales GENERATE ss_ticket_number;

join_storeReturns_storeSales = JOIN proy_storeSales BY ss_ticket_number, proy_storeReturns BY sr_ticket_number USING 'replicated';

STORE join_storeReturns_storeSales INTO 'queryResults/query.6.store_sales.store_returns.10.10' using PigStorage('|');

rm queryResults/query.6.store_sales.store_returns.10.10;
