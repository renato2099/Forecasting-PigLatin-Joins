...
query96_HdSs = JOIN ss_proy BY ss_hdemo_sk, hd_proy BY hd_demo_sk USING 'replicated';

STORE query96_HdSs INTO 'queryResults/query.96.store_sales.household_demographics.6.1' USING PigStorage('|');

rm queryResults/query.96.store_sales.household_demographics.6.1;
