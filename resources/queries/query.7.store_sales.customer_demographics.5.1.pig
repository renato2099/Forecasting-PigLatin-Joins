...
query7_CdSs = JOIN ss_proy BY ss_cdemo_sk, cd_proy BY cd_demo_sk USING 'replicated';

STORE query7_CdSs INTO 'queryResults/query.7.store_sales.customer_demographics.5.1' USING PigStorage('|');

rm queryResults/query.7.store_sales.customer_demographics.5.1;
