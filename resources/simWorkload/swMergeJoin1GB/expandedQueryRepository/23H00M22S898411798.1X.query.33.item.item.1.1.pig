...
join_item_item2 = JOIN proy_item BY i_item_sk, proy_item2 BY i_item_sk USING 'merge';

STORE join_item_item2 INTO 'queryResults/query.33.item.item.1.1' using PigStorage('|');

rm queryResults/query.33.item.item.1.1;
