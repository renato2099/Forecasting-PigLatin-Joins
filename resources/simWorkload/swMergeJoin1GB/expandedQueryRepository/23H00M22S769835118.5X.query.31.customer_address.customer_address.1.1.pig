...
proy_cAddress2 = FOREACH customer_address2 GENERATE ca_address_sk;
proy_cAddress = FOREACH customer_address GENERATE ca_address_sk;

join_cAddress_cAddress2 = JOIN proy_cAddress BY ca_address_sk, proy_cAddress2 BY ca_address_sk USING 'merge';
