...
proy_reason2 = FOREACH reason2 GENERATE r_reason_sk;

join_reason_reason2 = JOIN proy_reason BY r_reason_sk, proy_reason2 BY r_reason_sk USING 'merge';

STORE join_reason_reason2 INTO 'queryResults/query.33.reason.reason.1.1' using PigStorage('|');

rm queryResults/query.33.reason.reason.1.1;
