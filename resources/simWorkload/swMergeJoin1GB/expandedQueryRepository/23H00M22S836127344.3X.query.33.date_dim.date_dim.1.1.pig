...
proy_dateDim2 = FOREACH date_dim2 GENERATE d_date_sk;

join_dateDim_dateDim2 = JOIN proy_dateDim BY d_date_sk, proy_dateDim2 BY d_date_sk USING 'merge';

STORE join_dateDim_dateDim2 INTO 'queryResults/query.33.date_dim.date_dim.1.1' using PigStorage('|');

rm queryResults/query.33.date_dim.date_dim.1.1;
