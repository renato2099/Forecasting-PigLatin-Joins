...
proy_webPage2 = FOREACH web_page2 GENERATE wp_web_page_sk;

join_webPage_webPage2 = JOIN proy_webPage BY wp_web_page_sk, proy_webPage2 BY wp_web_page_sk USING 'merge';

STORE join_webPage_webPage2 INTO 'queryResults/query.31.web_page.web_page.1.1' USING PigStorage('|');

rm queryResults/query.31.web_page.web_page.1.1;
