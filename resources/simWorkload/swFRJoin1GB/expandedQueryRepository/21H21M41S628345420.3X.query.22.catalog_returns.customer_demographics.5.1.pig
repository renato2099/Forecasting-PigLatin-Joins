...
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_refunded_cdemo_sk;

join_catalogReturns_cDemo = JOIN proy_catalogReturns BY cr_refunded_cdemo_sk, proy_cDemo BY cd_demo_sk USING 'replicated';

STORE join_catalogReturns_cDemo INTO 'queryResults/query.22.catalog_returns.customer_demographics.5.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.customer_demographics.5.1;
