...
proy_customerAddress = FOREACH customer_address GENERATE ca_country;
proy_warehouse = FOREACH warehouse GENERATE w_country;

join_customerAddress_warehouse = JOIN proy_customerAddress BY ca_country, proy_warehouse BY w_country USING 'replicated';

STORE join_customerAddress_warehouse INTO 'queryResults/query.5.customer_address.warehouse.11.13' using PigStorage('|');

rm queryResults/query.5.customer_address.warehouse.11.13;
