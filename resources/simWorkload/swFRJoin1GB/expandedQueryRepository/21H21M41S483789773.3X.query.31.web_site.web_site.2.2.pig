...
joinWebSiteWebSite2 = JOIN proy_webSite BY web_site_sk, proy_webSite2 BY web_site_sk USING 'replicated';

STORE joinWebSiteWebSite2 INTO 'queryResults/query.75.web_site.web_site.2.2' USING PigStorage('|');

rm queryResults/query.75.web_site.web_site.2.2;
