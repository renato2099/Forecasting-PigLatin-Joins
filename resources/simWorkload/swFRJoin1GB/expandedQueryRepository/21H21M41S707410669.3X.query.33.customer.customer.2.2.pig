...
proy_customer = FOREACH customer GENERATE c_customer_id;
proy_customer2 = FOREACH customer2 GENERATE c_customer_id;

join_customer_customer2 = JOIN proy_customer BY c_customer_id, proy_customer2 BY c_customer_id USING 'replicated';

STORE join_customer_customer2 INTO 'queryResults/query.33.customer.customer.2.2' using PigStorage('|');

rm queryResults/query.33.customer.customer.2.2;
