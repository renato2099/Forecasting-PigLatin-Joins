...
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_warehouse_sk;

join_catalogReturns_warehouse = JOIN proy_catalogReturns BY cr_warehouse_sk, proy_warehouse BY w_warehouse_sk USING 'replicated';

STORE join_catalogReturns_warehouse INTO 'queryResults/query.22.catalog_returns.warehouse.15.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.warehouse.15.1;
