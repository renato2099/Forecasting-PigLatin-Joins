...
proy_webPage = FOREACH web_page GENERATE wp_web_page_sk;
proy_webReturns = FOREACH web_returns GENERATE wr_web_page_sk;

join_webReturns_webPage = JOIN proy_webReturns BY wr_web_page_sk, proy_webPage BY wp_web_page_sk USING 'replicated';

STORE join_webReturns_webPage INTO 'queryResults/query.66.web_returns.web_page.12.1' USING PigStorage('|');

rm queryResults/query.66.web_returns.web_page.12.1;
