...
proy_customerAddress = FOREACH customer_address GENERATE ca_city;
proy_warehouse = FOREACH warehouse GENERATE w_city;

join_customerAddress_warehouse = JOIN proy_customerAddress BY ca_city, proy_warehouse BY w_city USING 'replicated';

STORE join_customerAddress_warehouse INTO 'queryResults/query.5.customer_address.warehouse.7.9' using PigStorage('|');

rm queryResults/query.5.customer_address.warehouse.7.9;
