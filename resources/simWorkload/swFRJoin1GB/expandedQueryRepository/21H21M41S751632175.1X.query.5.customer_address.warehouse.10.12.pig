...
proy_customerAddress = FOREACH customer_address GENERATE ca_zip;
proy_warehouse = FOREACH warehouse GENERATE w_zip;

join_customerAddress_warehouse = JOIN proy_customerAddress BY ca_zip, proy_warehouse BY w_zip USING 'replicated';

STORE join_customerAddress_warehouse INTO 'queryResults/query.5.customer_address.warehouse.10.12' using PigStorage('|');

rm queryResults/query.5.customer_address.warehouse.10.12;
