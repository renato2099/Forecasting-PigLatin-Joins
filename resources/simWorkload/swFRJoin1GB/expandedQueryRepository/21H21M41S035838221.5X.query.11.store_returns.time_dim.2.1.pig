...
join_timeDim_storeReturns = JOIN proy_storeReturns BY sr_return_time_sk, proy_timeDim BY t_time_sk USING 'replicated';

STORE join_timeDim_storeReturns INTO 'queryResults/query.11.store_returns.time_dim.2.1' using PigStorage('|');

rm queryResults/query.11.store_returns.time_dim.2.1;
