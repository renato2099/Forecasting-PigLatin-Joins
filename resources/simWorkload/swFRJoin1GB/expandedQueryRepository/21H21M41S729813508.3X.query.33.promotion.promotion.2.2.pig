...
proy_promotion = FOREACH promotion GENERATE p_promo_id;
proy_promotion2 = FOREACH promotion2 GENERATE p_promo_id;

join_promotion_promotion2 = JOIN proy_promotion BY p_promo_id, proy_promotion2 BY p_promo_id USING 'replicated';

STORE join_promotion_promotion2 INTO 'queryResults/query.33.promotion.promotion.2.2' USING PigStorage('|');

rm queryResults/query.33.promotion.promotion.2.2;
