...
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_reason_sk;

join_catalogReturns_reason = JOIN proy_catalogReturns BY cr_reason_sk, proy_reason BY r_reason_sk USING 'replicated';

STORE join_catalogReturns_reason INTO 'queryResults/query.22.catalog_returns.reason.16.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.reason.16.1;
