...
proy_customerAddress = FOREACH customer_address GENERATE ca_state;
proy_warehouse = FOREACH warehouse GENERATE w_state;

join_customerAddress_warehouse = JOIN proy_customerAddress BY ca_state, proy_warehouse BY w_state USING 'replicated';

STORE join_customerAddress_warehouse INTO 'queryResults/query.5.customer_address.warehouse.9.11' using PigStorage('|');

rm queryResults/query.5.customer_address.warehouse.9.11;
