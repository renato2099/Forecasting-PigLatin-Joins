...
proy_timeDim = FOREACH time_dim GENERATE t_time_id;
proy_timeDim2 = FOREACH time_dim2 GENERATE t_time_id;

join_timeDim_timeDim2 = JOIN proy_timeDim BY t_time_id, proy_timeDim BY t_time_id USING 'replicated';

STORE join_timeDim_timeDim2 INTO 'queryResults/query.33.time_dim.time_dim.2.2' using PigStorage('|');

rm queryResults/query.33.time_dim.time_dim.2.2;
