...
proy_catalogSales = FOREACH catalog_sales GENERATE cs_item_sk;
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_item_sk;

join_catalogSales_catalogReturns = JOIN proy_catalogSales BY cs_item_sk, proy_catalogReturns BY cr_item_sk USING 'replicated';

STORE join_catalogSales_catalogReturns INTO 'queryResults/query.6.catalog_sales.catalog_returns.16.3' using PigStorage('|');

rm queryResults/query.6.catalog_sales.catalog_returns.16.3;
