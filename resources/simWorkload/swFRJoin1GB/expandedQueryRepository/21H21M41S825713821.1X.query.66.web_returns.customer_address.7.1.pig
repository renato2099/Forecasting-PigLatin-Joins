...
proy_webReturns = FOREACH web_returns GENERATE wr_refunded_addr_sk;

join_webReturns_cAddress = JOIN proy_webReturns BY wr_refunded_addr_sk, proy_cAddress BY ca_address_sk USING 'replicated';

STORE join_webReturns_cAddress INTO 'queryResults/query.66.web_returns.customer_address.7.1' USING PigStorage('|');

rm queryResults/query.66.web_returns.customer_address.7.1;
