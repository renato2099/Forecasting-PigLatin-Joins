...
proy_webReturns = FOREACH web_returns GENERATE wr_returned_time_sk;

join_webReturns_timeDim = JOIN proy_webReturns BY wr_returned_time_sk, proy_timeDim BY t_time_sk USING 'replicated';

STORE join_webReturns_timeDim INTO 'queryResults/query.66.web_returns.time_dim.2.1' USING PigStorage('|');

rm queryResults/query.66.web_returns.time_dim.2.1;
