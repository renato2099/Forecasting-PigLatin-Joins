...
proy_webReturns = FOREACH web_returns GENERATE wr_refunded_hdemo_sk;

join_webReturns_hhDemo = JOIN proy_webReturns BY wr_refunded_hdemo_sk, proy_hhDemo BY hd_demo_sk USING 'replicated';

STORE join_webReturns_hhDemo INTO 'queryResults/query.66.web_returns.household_demographics.6.1' USING PigStorage('|');

rm queryResults/query.66.web_returns.household_demographics.6.1;
