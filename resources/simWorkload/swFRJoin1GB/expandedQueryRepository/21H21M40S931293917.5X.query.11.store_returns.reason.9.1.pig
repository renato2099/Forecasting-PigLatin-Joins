...
join_reason_storeReturns = JOIN proy_storeReturns BY sr_reason_sk, proy_reason BY r_reason_sk USING 'replicated';

STORE join_reason_storeReturns INTO 'queryResults/query.11.store_returns.reason.9.1' using PigStorage('|');

rm queryResults/query.11.store_returns.reason.9.1;
