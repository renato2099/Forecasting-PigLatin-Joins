...
proy_cAdd = FOREACH customer_address GENERATE ca_address_sk;
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_refunded_addr_sk;

join_catalogReturns_cAdd = JOIN proy_catalogReturns BY cr_refunded_addr_sk, proy_cAdd BY ca_address_sk USING 'replicated';

STORE join_catalogReturns_cAdd INTO 'queryResults/query.22.catalog_returns.customer_address.7.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.customer_address.7.1;
