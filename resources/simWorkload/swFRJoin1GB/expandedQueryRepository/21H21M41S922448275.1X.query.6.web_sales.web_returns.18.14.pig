...
proy_webSales = FOREACH web_sales GENERATE ws_order_number;
proy_webReturns = FOREACH web_returns GENERATE wr_order_number;

join_webSales_webReturns = JOIN proy_webSales BY ws_order_number, proy_webReturns BY wr_order_number USING 'replicated';

STORE join_webSales_webReturns INTO 'queryResults/query6.web_sales.web_returns.18.14' USING PigStorage('|');

rm queryResults/query6.web_sales.web_returns.18.14;
