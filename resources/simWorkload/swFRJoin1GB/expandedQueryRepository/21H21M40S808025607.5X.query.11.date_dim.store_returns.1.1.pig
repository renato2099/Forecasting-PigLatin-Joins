...
join_storeReturns_dateDim = JOIN proy_dateDim BY d_date_sk, proy_storeReturns BY sr_returned_date_sk USING 'replicated';

STORE join_storeReturns_dateDim INTO 'queryResults/query.11.date_dim.store_returns.1.1' using PigStorage('|');

rm queryResults/query.11.date_dim.store_returns.1.1;
