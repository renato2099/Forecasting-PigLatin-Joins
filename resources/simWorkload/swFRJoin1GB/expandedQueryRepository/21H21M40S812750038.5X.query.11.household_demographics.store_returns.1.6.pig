...
join_hDemographics_storeReturns = JOIN proy_hDemographics BY hd_demo_sk, proy_storeReturns BY sr_hdemo_sk USING 'replicated';

STORE join_hDemographics_storeReturns INTO 'queryResults/query.11.household_demographics.store_returns.1.6' using PigStorage('|');

rm queryResults/query.11.household_demographics.store_returns.1.6;
