...
proy_webSales = FOREACH web_sales GENERATE ws_bill_addr_sk;
proy_cAddress = FOREACH customer_address GENERATE ca_address_sk;

joinWebSalesCAddress = JOIN proy_webSales BY ws_bill_addr_sk, proy_cAddress BY ca_address_sk USING 'replicated';

STORE joinWebSalesCAddress INTO 'queryResults/query.75.web_sales.customer_address.8.1' USING PigStorage('|');

rm queryResults/query.75.web_sales.customer_address.8.1;
