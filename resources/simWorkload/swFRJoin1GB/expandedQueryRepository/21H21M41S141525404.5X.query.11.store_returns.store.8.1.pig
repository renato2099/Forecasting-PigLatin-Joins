...
join_store_storeReturns = JOIN proy_storeReturns BY sr_store_sk, proy_store BY s_store_sk USING 'replicated';

STORE join_store_storeReturns INTO 'queryResults/query.11.store_returns.store.8.1' using PigStorage('|');

rm queryResults/query.11.store_returns.store.8.1;
