...
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_refunded_customer_sk;

join_catalogReturns_customer = JOIN proy_catalogReturns BY cr_refunded_customer_sk, proy_customer BY c_customer_sk USING 'replicated';

STORE join_catalogReturns_customer INTO 'queryResults/query.22.catalog_returns.customer.4.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.customer.4.1;
