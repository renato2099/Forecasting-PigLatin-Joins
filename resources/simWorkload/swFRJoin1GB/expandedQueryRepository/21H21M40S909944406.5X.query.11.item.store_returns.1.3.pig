...
join_item_storeReturns = JOIN proy_item BY i_item_sk, proy_storeReturns BY sr_item_sk USING 'replicated';

STORE join_item_storeReturns INTO 'queryResults/query.11.item.store_returns.1.3' using PigStorage('|');

rm queryResults/query.11.item.store_returns.1.3;
