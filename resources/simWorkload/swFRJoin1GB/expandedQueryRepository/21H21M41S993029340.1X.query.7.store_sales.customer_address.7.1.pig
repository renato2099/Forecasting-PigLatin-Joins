...
joinCAddressSSales = JOIN ss_proy BY ss_addr_sk, ca_proy BY ca_address_sk USING 'replicated';

STORE joinCAddressSSales INTO 'queryResults/query.7.store_sales.customer_address.7.1' USING PigStorage('|');

rm queryResults/query.7.store_sales.customer_address.7.1;
