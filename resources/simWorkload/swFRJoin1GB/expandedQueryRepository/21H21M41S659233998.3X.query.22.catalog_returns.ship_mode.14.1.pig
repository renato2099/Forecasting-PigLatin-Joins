...
proy_catalogReturns = FOREACH catalog_returns GENERATE cr_ship_mode_sk;

join_catalogReturns_shipMode = JOIN proy_catalogReturns BY cr_ship_mode_sk, proy_shipMode BY sm_ship_mode_sk USING 'replicated';

STORE join_catalogReturns_shipMode INTO 'queryResults/query.22.catalog_returns.shipMode.14.1' using PigStorage('|');

rm queryResults/query.22.catalog_returns.shipMode.14.1;
