...
proy_customerAddress = FOREACH customer_address GENERATE ca_county;
proy_warehouse = FOREACH warehouse GENERATE w_county;

join_customerAddress_warehouse = JOIN proy_customerAddress BY ca_county, proy_warehouse BY w_county USING 'replicated';

STORE join_customerAddress_warehouse INTO 'queryResults/query.5.customer_address.warehouse.8.10' using PigStorage('|');

rm queryResults/query.5.customer_address.warehouse.8.10;
