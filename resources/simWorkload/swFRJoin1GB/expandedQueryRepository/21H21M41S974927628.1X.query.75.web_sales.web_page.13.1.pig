...
proy_webSales = FOREACH web_sales GENERATE ws_web_page_sk;
proy_webPage = FOREACH web_page GENERATE wp_web_page_sk;

joinWebSalesWebPage = JOIN proy_webSales BY ws_web_page_sk, proy_webPage BY wp_web_page_sk USING 'replicated';

STORE joinWebSalesWebPage INTO 'queryResults/query.75.web_sales.webPage.13.1' USING PigStorage('|');

rm queryResults/query.75.web_sales.webPage.13.1;
