...
join_storeReturns_storeSales = JOIN proy_storeReturns BY sr_item_sk, proy_storeSales BY ss_item_sk;

STORE join_storeReturns_storeSales INTO 'queryResults/query.6.store_returns.store_sales.3.3' using PigStorage('|');

rm queryResults/query.6.store_returns.store_sales.3.3;
