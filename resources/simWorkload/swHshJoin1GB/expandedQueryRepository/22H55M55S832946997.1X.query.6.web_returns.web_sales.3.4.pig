...
join_webSales_webReturns = JOIN proy_webReturns BY wr_item_sk, proy_webSales BY ws_item_sk;

STORE join_webSales_webReturns INTO 'queryResults/query6.web_returns.web_sales.3.4' USING PigStorage('|');

rm queryResults/query6.web_returns.web_sales.3.4;
