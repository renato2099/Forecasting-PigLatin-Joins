...
join_storeReturns_storeSales = JOIN proy_storeReturns BY sr_ticket_number, proy_storeSales BY ss_ticket_number;

STORE join_storeReturns_storeSales INTO 'queryResults/query.6.store_returns.store_sales.10.10' using PigStorage('|');

rm queryResults/query.6.store_returns.store_sales.10.10;
