...
proy_webSales2 = FOREACH web_sales2 GENERATE ws_bill_customer_sk;

joinWebSalesWebSales2 = JOIN proy_webSales BY ws_bill_customer_sk, proy_webSales2 BY ws_bill_customer_sk;

STORE joinWebSalesWebSales2 INTO 'queryResults/query.31.web_sales.web_sales.5.5' USING PigStorage('|');

rm queryResults/query.31.web_sales.web_sales.5.5;
