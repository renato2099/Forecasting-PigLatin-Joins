...
public class InputSampler extends Configured implements Tool  {
  ...
  private static final Logger LOG = Logger.getLogger(InputSampler.class);
 ...
 * @param <K>
   ...
   * @param <K>
   */
  public static class SplitSampler<K> implements Sampler {
    ...
    public K[] getSample(InputFormat inf, Job job) 
        throws IOException, InterruptedException {
      ...
      for (int i = 0; i < splitsToSample; ++i) {
        ...
        RecordReader reader = inf.createRecordReader(
 ...
 * @param <K>
   */
  public static class RandomSampler<K> implements Sampler {
    private double freq;
    private final int numSamples;
    private final int maxSplitsSampled;
 ...
 * @param <K>
   */
  public static class IntervalSampler<K> implements Sampler {
 ...
 * @param <K>
  ...
  public static  <K> void writePartitionFile(Job job, Sampler sampler) 
    ...
    Path dst = new Path(TotalOrderPartitioner.getPartitionFile((JobConf) conf));
  ...
  public int run(String[] args) throws Exception {
    ...
    TotalOrderPartitioner.setPartitionFile((JobConf) getConf(), outf);
